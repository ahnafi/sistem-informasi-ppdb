...
<div class="bg-white relative w-full min-h-screen overflow-x-hidden">
    ...
    <div class="absolute w-full h-[455px] left-0 top-0 flex flex-col items-start gap-2.5 isolate">
        <div class="absolute w-full h-full left-0 top-0">
            ...
            <div class="absolute w-full h-full left-0 top-0 bg-gradient-to-r from-blue-600/70 via-blue-500/40 to-blue-400/30"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full h-full flex items-center z-10">
            <div class="flex flex-col items-start gap-4">
                <div class="flex flex-col items-start gap-2">
                    <h1 class="font-roboto font-medium text-[50px] leading-[59px] text-white drop-shadow-lg">Akademik</h1>
    ...
    <div class="py-16 bg-white mt-[455px]">
