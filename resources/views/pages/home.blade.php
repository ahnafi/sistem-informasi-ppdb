...
@section('main')
<!-- ========== HERO SECTION  ========== -->
<div class="relative overflow-hidden h-screen min-h-[600px] flex items-center justify-center">
  <!-- Dynamic background  -->
  <div class="absolute inset-0 z-0">
    <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('{{ asset('images/logonobg.png') }}');">
    </div>
    <div class="absolute inset-0 bg-gradient-to-r from-blue-950/90 via-blue-900/80 to-blue-800/70"></div>
  </div>
  
  <div class="absolute inset-0 z-10 overflow-hidden pointer-events-none">
    <div class="absolute top-1/4 left-[-5%] w-40 h-40 rounded-full bg-white/10 blur-2xl animate-float" style="animation-delay: -2s; animation-duration: 15s;"></div>
    <div class="absolute top-1/2 right-[10%] w-56 h-56 rounded-full bg-white/5 blur-3xl animate-float" style="animation-delay: -5s; animation-duration: 18s;"></div>
    
    <div class="absolute top-1/4 left-[30%] w-2 h-2 rounded-full bg-white/80 blur-[1px] animate-pulse-slow" style="animation-duration: 2s;"></div>
    <div class="absolute top-1/3 right-[40%] w-1 h-1 rounded-full bg-white/70 blur-[0.5px] animate-pulse-slow" style="animation-duration: 3s;"></div>
    <div class="absolute bottom-1/4 left-[70%] w-1.5 h-1.5 rounded-full bg-white/80 blur-[0.5px] animate-pulse-slow" style="animation-duration: 4s;"></div>
    <div class="absolute top-2/3 right-[20%] w-2 h-2 rounded-full bg-white/80 blur-[1px] animate-pulse-slow" style="animation-duration: 3.5s;"></div>
    
    <div class="absolute top-[15%] left-[15%] opacity-10">
      <img src="{{ asset('images/magical-symbol-1.png') }}" class="w-24 h-24 animate-float" style="animation-duration: 10s;">
    </div>
    <div class="absolute bottom-[20%] right-[15%] opacity-10">
      <img src="{{ asset('images/magical-symbol-2.png') }}" class="w-20 h-20 animate-float" style="animation-duration: 8s; animation-delay: -3s;">
    </div>
  </div>

  <!-- Main hero content -->
  <div class="container max-w-7xl mx-auto px-4 relative z-20 mt-[-80px]">
    <div class="flex flex-col md:flex-row items-center justify-between gap-12">
      ...
      <div class="md:w-1/2 text-center md:text-left">
        ...
        <h1 class="text-4xl md:text-6xl font-extrabold text-white mb-4 leading-tight">
          ...
          <span class="bg-clip-text text-transparent bg-gradient-to-r from-blue-300 to-indigo-300">SMA Hogwarts</span>
        </h1>
        ...
        <!-- Scroll indicator -->
        <div class="hidden md:flex items-center gap-3 mt-16 text-blue-200 animate-bounce">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3" />
          </svg>
          <span class="text-sm">Jelajahi Lebih Jauh</span>
        </div>
      </div>
      ...
      <div class="md:w-1/2 flex justify-center">
        <div class="relative">
          ...
          <div class="absolute inset-0 bg-blue-500/20 blur-3xl rounded-full animate-pulse-slow"></div>
          
          <!-- School crest -->
          <div class="relative z-10">
            <img src="{{ asset('images/logonobg.png') }}" alt="Hogwarts School Crest" class="w-80 h-auto drop-shadow-2xl animate-float">
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="absolute bottom-0 left-0 w-full z-20">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" class="w-full h-auto">
      <path fill="#ffffff" fill-opacity="1" d="M0,192L40,197.3C80,203,160,213,240,186.7C320,160,400,96,480,90.7C560,85,640,139,720,149.3C800,160,880,128,960,112C1040,96,1120,96,1200,101.3C1280,107,1360,117,1400,122.7L1440,128L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path>
    </svg>
  </div>
</div>
      ...
      <div class="md:w-1/2 reveal">
        ...
        <div class="grid grid-cols-3 gap-4 mt-6">
          <div class="overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-all cursor-pointer">
            <img src="{{ asset('images/hogwarts-library.jpg') }}" alt="Library" class="w-full h-24 object-cover hover:scale-110 transition-transform duration-500">
          </div>
          <div class="overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-all cursor-pointer">
            <img src="{{ asset('images/hogwarts-classroom.jpg') }}" alt="Classroom" class="w-full h-24 object-cover hover:scale-110 transition-transform duration-500">
          </div>
          <div class="overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-all cursor-pointer">
            <img src="{{ asset('images/hogwarts-garden.jpg') }}" alt="Garden" class="w-full h-24 object-cover hover:scale-110 transition-transform duration-500">
          </div>
        </div>
      </div>
      ...
      <div class="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 p-8 lg:p-12">
        ...
        <div class="flex flex-col justify-center">
          ...
          <div class="flex flex-wrap gap-4">
            <a href="{{ route('registration') }}" class="magic-hover inline-flex justify-center items-center gap-x-2 text-center bg-white hover:bg-blue-50 text-blue-800 font-semibold rounded-full px-6 py-3.5 shadow-lg shadow-blue-500/20 transition">
              Daftar Sekarang
            ...
            <a href="#" class="inline-flex justify-center items-center gap-x-2 text-center border border-white/30 hover:border-white/60 text-white hover:bg-white/10 font-medium rounded-full px-6 py-3.5 transition">
        ...
        <div class="hidden lg:flex items-center justify-center">
          <div class="relative">
            ...
            <img src="{{ asset('images/sorting-hat.png') }}" alt="Magical Sorting Hat" class="relative z-10 w-96 drop-shadow-2xl animate-float">
          </div>
        </div>
      </div>
    </div>
...
<section class="py-24 bg-gradient-to-b from-blue-50 via-white to-white relative overflow-hidden">
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div class="relative group reveal reveal-delay-200">
        ...
        <div class="h-full bg-gradient-to-br from-white to-blue-50 rounded-3xl shadow-xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:translate-y-[-8px]">
          ...
          <div class="relative h-64 overflow-hidden">
            <img 
              src="{{ asset('images/prestasi-1.jpg') }}" 
          ...
          <div class="p-6">
            <div class="flex items-center gap-2 mb-4">
              <img src="{{ asset('images/medal-gold.png') }}" alt="Gold Medal" class="w-8 h-8">
              <span class="text-amber-600 font-semibold">5 Medali Emas</span>
            </div>
      ...
      <div class="relative group reveal reveal-delay-400">
        <div class="h-full bg-gradient-to-br from-white to-indigo-50 rounded-3xl shadow-xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:translate-y-[-8px]">
          ...
          <div class="relative h-64 overflow-hidden">
            <img 
              src="{{ asset('images/prestasi-2.jpg') }}" 
              class="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110" 
          ...
          <div class="p-6">
            <div class="flex items-center gap-2 mb-4">
              <img src="{{ asset('images/trophy.png') }}" alt="Trophy" class="w-8 h-8">
    ...
    <!-- Enhanced "View All" button with magical glowing effect -->
